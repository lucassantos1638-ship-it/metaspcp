...
export default function FormularioIniciarAtividade() {
    ...
    iniciarProducao.mutate(
      {
        ...
        etapa_id: isAtividadeAvulsa ? null : etapaId,
        subetapa_id: isAtividadeAvulsa ? null : (subetapaId || null),
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {!isAtividadeAvulsa && selectedLote && selectedLote.quantidade_total <= 0 && etapaId && listaEtapas && listaEtapas.find(e => e.id === etapaId)?.ordem > 1 && (
